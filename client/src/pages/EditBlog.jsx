    ...
    return (
        <>
            ...
            <div className="text-center my-10">
                <button type="button" onClick={handleSubmit} className={`inline-flex items-center px-5 py-3 font-semibold leading-6 text-md shadow rounded-md text-white bg-blue-500 transition ease-in-out duration-150 ${isSubmitting ? 'cursor-not-allowed hover:bg-blue-400' : 'hover:bg-blue-600'}`} >
